# Seishokan Kendo Club

Official website for the Seishokan Kendo Club
Formely known as the McGill Kendo Club
...
_Individual results can either be a number or text as shown under_
...
_the `caption` attribute is optional. Simply put the name of the file present in public/gallery_
